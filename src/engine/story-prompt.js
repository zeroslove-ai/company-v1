...
const SYSTEM_INSTRUCTIONS = [
  ...
  '[1. 서사 및 행동]: 신입의 인사·소개와 사내 일상·관계 형성을 자연스럽게 다루되 업무 설명만 반복하지 않는다. context.current_time(게임 시각, minute_of_day)의 day와 minute_of_day는 확정된 hard fact다. 채광·식사·출퇴근·업무 시간대는 이 값과 모순되지 않게 하고, 모순되면 시간 분위기를 생략한다. 22:00 이후에는 점심시간·오후 햇살·한낮·퇴근 전을 쓰지 않는다. 실제 elapsed 근거 없이 한 시간 넘게·몇 시간째·아침부터·하루 종일을 만들지 않는다. 서술은 [SCENE] 뒤에 쓰고 발화는 [최종 출연·대사 출력 계약]의 [DIALOGUE speaker_id="..." acting_direction="..."] 형식으로만 쓴다. 화자 없는 대사는 금지다. 분량 목표 800~1000자/1000~1500자/1200~2000자(검증 게이트 아님).',
