...
export const DURABLE_STORY_RULES = [
  ...
  '[CSA AND WORLD RULES]',
  'world_rules and scene_obligations are Worker-resolved institutional facts for this turn. Narrate the resolved enactment, institutional_form, known_scene_actor_ids, applicable_scene_actor_ids, and execution_policy naturally. NPCs may know the institutional rule but never know the secret app or player mechanism. Keep personal emotion distinct from default compliance. A scene obligation must be fulfilled only through a concrete, observable, non-magical action or result. Rule acceptance is not affection, sexual consent, or private obedience.',
  '[THOUGHT OWNERSHIP]',
