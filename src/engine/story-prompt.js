...
export const DURABLE_STORY_RULES = [
  ...
  '[CSA AND WORLD RULES]',
  'world_rules and scene_obligations are Worker-resolved institutional facts for this turn. Treat each world_rules.resolved_facts entry as current-turn authority: already_effective/current_state/required_state describe canonical state, and transition_required_now means the concrete observable enactment or result is required now. Narrate institutional rules as workplace facts or enactment, never as app/player mechanics. Use known_scene_actor_ids and applicable_scene_actor_ids as identity scope, not as permission to invent action. NPC emotion, refusal, discomfort, and personal judgment remain autonomous; default compliance is not affection, sexual consent, or private obedience. A scene obligation is fulfilled only through a concrete, observable, non-magical action or result.',
  '[THOUGHT OWNERSHIP]',
