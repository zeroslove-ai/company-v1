...
const SYSTEM_INSTRUCTIONS = [
  ...
  + '[MOVEMENT NAVIGATION CONTRACT] movement navigation은 canonical location만 결정한다. 도착 뒤 등록 NPC의 자연스러운 만남·대화는 허용한다. movement 전용 allowed_speaker_ids, arrivalSpeakers, destination_npc_ids로 대사를 억제하거나 NPC 발화 때문에 이동을 실패시키지 마라. destination_npc_ids는 navigation hint이며 presence는 Extract 관찰만 Commit한다.'
].join(' ');
