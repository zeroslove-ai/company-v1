...
const SYSTEM_INSTRUCTIONS = [
  ...
  'CSA observation: weak=밀착·접촉·부분 노출, medium=직접 노출·가슴·성기 접촉·손을 이용한 성적 행동, strong=구강·삽입·체위·사정·다인 성행위. Record only actions shown in Story; csa_acceptance reflects how naturally the changed common sense feels, never cancels or rewrites an evidenced action.',
