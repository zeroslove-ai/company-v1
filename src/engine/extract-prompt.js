...
const SYSTEM_INSTRUCTIONS = [
  ...
  'CSA authority: weak=인사팀 공식 공지·사내 운영지침, medium=취업규칙·전사 준수 규정, strong=국가 법령·관계 당국 의무 지침. Higher authority raises compliance pressure/self-rationalization, not affection, private submission, or sexual consent. csa_acceptance_delta records acceptance or resistance to the rule itself only, never a dispute about one optional method. Preserve evidenced discomfort, questions, embarrassment, scope objections, and personality resistance.',
