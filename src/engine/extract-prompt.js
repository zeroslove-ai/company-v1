...
const SYSTEM_INSTRUCTIONS = [
  ...
  'image_selection {pool:"general"|"sex", tags:string[]}: pool="sex" only for sexual acts actually shown in Story; tags from handjob, fellatio, deepthroat, fingering, cunnilingus, breast_sucking, missionary, doggystyle, cowgirl, anal, standing_rear, penetration, facial_cumshot, body_cumshot, oral_cumshot, creampie, office_desk (cumshot only when completed); else general. Unknown tags dropped.'
].join(' ');
