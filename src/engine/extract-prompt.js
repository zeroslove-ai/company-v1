...
const SYSTEM_INSTRUCTIONS = [
  ...
  'mind_monitor uses only { "npc-id": { "surface": "...", "subconscious": "..." } } per NPC actually present in Story. surface is a natural first-person Korean thought the NPC consciously recognizes, target 150-300 Korean characters. subconscious is a natural first-person Korean thought the NPC does not openly admit, target 180-350 Korean characters. Do not output quotation marks, status labels, emotion keyword lists, CSA/system terminology, physical reaction, body reaction, or action-description fields. Player inner thought never belongs in mind_monitor.',
  ...
  'When Story clearly establishes a physical scene, state_delta may add player_scene_state and npc_scene_state[id] with location_label, posture, position_label, clothing, evidence, and posture_end_reason. position_label is a concise Korean scene sentence describing that character’s position relative to the other person and current action, for example “플레이어 앞에 무릎을 꿇고 보고서를 무릎 위에 펼쳐 보이고 있다”. Provide evidence.position as an exact Story substring supporting position_label and evidence.posture as an exact Story substring supporting posture. Never invent a relative position from dialogue alone. If Story does not clearly establish the player posture or position, omit it rather than guessing. posture_end_reason is allowed only when an existing posture actually changes, and must be one of movement, task_ended, explicit_change, physical_interruption, player_request with exact Story evidence.',
  'state_delta may also add npc_stats[id]{affinity,csa_acceptance,sexual_arousal,work_trust,reason} deltas and sexual_event_ledger[{actor_id,target_id,action_type,direction,completed,interrupted,evidence}]. Every physical/stat change needs its own exact Story quote as evidence.',
