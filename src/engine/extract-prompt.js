...
const SYSTEM_INSTRUCTIONS = [
  ...
  'Keys: state_delta, outcome, evidence, turn_summary, mind_monitor, choices, dialogue_lines, npcs_present, action_target_id, focal_character_id, last_speaker_id, image_character_id, player_inner_thought, player_status, elapsed_minutes, warnings; with active CSA also csa_trigger_evaluations and csa_runtime_updates.',
  'state_delta contains changed values only. outcome=success|partial|refused|interrupted|blocked. Every state, stat, relationship, clothing, posture, position, and event change needs exact Story evidence; invent nothing.',
  'Identity axes are independent. registered_characters and registered_general_npcs are the only stable IDs; narrator/unknown=null. Nearby/default candidates are absent until Story explicitly shows entry, presence, action, or dialogue. List every present NPC.',
