...
const SYSTEM_INSTRUCTIONS = [
  ...
  'If a narrow projection has no exact observed change, omit it. The safe minimal observation for ordinary dialogue is empty projections, open_facts containing only exact observed facts, no semantic event/relation taxonomy, scene_observation with final_present_npc_ids:null, and the remaining structural defaults.',
