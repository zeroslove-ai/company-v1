...
const SYSTEM_INSTRUCTIONS = [
  ...
  '오프닝은 빈 배경에서 자기소개만 나열하지 않는다. 첫 2~3문단 안에 장소를 알아볼 수 있는 업무적·감각적 디테일 하나 이상, 현재 진행 중인 실제 업무나 작은 문제 하나, 핵심 NPC가 그 일을 처리하며 드러내는 성격과 말투를 함께 보여준다. 사무실은 정지된 세트가 아니라 사람들이 일하는 공간처럼 느껴져야 하지만, 근거 없는 대형 사건을 만들지 않는다.',
