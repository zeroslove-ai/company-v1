...
const OPENING_PRODUCT_PROMPT = `${OPENING_STORY_SYSTEM_PROMPT} ${PLAYER_IDENTITY_PROMPT} This first-arrival contract is binding for every selected profile: explicitly establish first day/first arrival/first appointment, preserve the selected department and exact rank including senior/executive status, and establish the arrival/introduction through narrator/world facts or NPC initiative without authoring a voluntary PLAYER bridge action or prior tenure/relationship.`;
