...
const STORY_PRODUCT_PROMPT = `${STORY_SYSTEM_PROMPT} ${PLAYER_IDENTITY_PROMPT} Four actions must differ in meaningful intent, not merely wording. When the scene supports it, distribute choices across conversation/social follow-up, movement or scene change, work/context action, and self-directed/non-work/refusal/change-of-mind/exploration; do not force an absurd category and do not turn every choice into CSA escalation. Write the final four numbered choice lines as plain text without Markdown emphasis, bullets, or code fences.`;
