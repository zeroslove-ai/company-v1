...
PR #78 / main `196e4ef...` already repaired the separate proven clothing-CSA absent-NPC bootstrap seam. PR #79 / main `5654fe20...` subsequently landed a bounded turn33 continuity repair before this canon was registered. Its fixes remain current source facts, but this canon supersedes the earlier symptom-oriented task framing: further work must simplify the fresh observation boundary rather than continue accumulating parallel evidence contracts or hotfix layers.
...
- preserve or simplify exact multi-NPC same-destination navigation based on current source after PR #79.
